...
class Service_ios_v10 extends CI_Controller {
...
*/
        ...
        /* Check api version */
        $check_version_array = array("android" => array("version" => "47", "compulsory" => "yes", "message" => "New version available please update it and enjoy new feature."), "ios" => array("version" => "1.3.10", "compulsory" => "yes", "message" => "New version available please update it and enjoy new feature."));
        $configuration = array("MERCHANT_ID" => $MERCHANT_ID, "MERCHANT" => $MERCHANT_KEY, "SALT" => $SALT, 'URl' => $URL, "WalletIsUsedInPackagePayment" => "0");
        $data3 = $this->service_model->master_fun_get_tbl_val("offer_master", array("status" => 1), array("id", "asc"));
