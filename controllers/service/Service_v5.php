...
class Service_v5 extends CI_Controller {
...
/// ---------for half payment add_job --
    ...
    function health_feed() {
        ...
        /* Check api version */
        $check_version_array = array("android" => array("version" => "45", "compulsory" => "yes", "message" => "New version available please update it and enjoy new feature."), "ios" => array("version" => "2", "compulsory" => "no", "message" => "New version available please update it and enjoy new feature."));
...
' . $payfrom_wallet . '
    ...
    function home_page() {
        ...
        if (empty($package_data)) {
            ...
            echo $this->json_data("1", "", array(array("data1" => $data3, "images" => $images, "package_data" => $package_data, "pay_conf" => $configuration, "version_check" => $check_version_array)));
        }
    }
    ...
    function add_address() {
        ...
        $row = $this->service_model->master_num_rows("user_address", array("user_fk" => $uid, "address" => $address, "landmark" => $landmark, "area" => $area, "status" => 1));
        if ($row == 0) {
            $this->service_model->master_fun_insert("user_address", array("user_fk" => $uid, "address" => $address, "landmark" => $landmark, "area" => $area));
        }
        echo $this->json_data("1", "", "");
    }
