...
class Lab_model extends CI_Model {
    ...
    function sample_list($lab,$one = null, $two = null) {
        ...
        $qry = "SELECT `logistic_log`.*,sample_job_master.`customer_name`,`sample_job_master`.`customer_gender`,`sample_job_master`.`customer_dob`, `phlebo_master`.`name`,`phlebo_master`.`mobile`,`collect_from`.`name` AS `c_name` FROM `logistic_log` 
