            ...
            <div class="col-xs-12">
                <div class="box box-primary" style="min-height: 500px;">
                    ...
                    <?php if ($login_data['type'] != 5) { ?>
                                                                                                                                                                0                                                                <a style="float:right; display:none;" href='<?php echo base_url(); ?>job_master/export_csv/1' class="btn btn-primary btn-sm" ><i class="fa fa-download" ></i><strong > Export To CSV</strong></a>
                    <?php } ?>
                                 </div>
                             </div>
                         </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            <div class="widget">
                                <?php echo form_open("job_master/pending_list_search", array("method" => "GET", "role" => "form", "id" => "job_search")); ?>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3" style="margin-bottom:10px;">
                                        ...
                                        <select class="form-control chosen-select" onchange="get_branch(this.value);" data-placeholder="Select Test city" tabindex="-1" name="city" id="citiess">
...
<?= form_close(); ?>
 ...
 <?php echo form_open("add_result/reporttest_preview/",array("method" => "POST","id"=>'printmyForm', "role" => "form")); ?>
                                <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        if (value.details) {
                            $.each(value.details, function (index1, value1) {
                                ...
                                if (tst_outsource_result.length > 0) {
                                    $.each(tst_outsource_result, function (index2, value22) {
                                        if ($("#test_" + value22.job_fk + "_" + value22.test_fk)) {
                                            $("#test_" + value22.job_fk + "_" + value22.test_fk).attr("style", "background:blue;color:white;");
                                        }
                                    });
                                }
                                var tst_approve_result = value1.approve;
...
$('#printmyForm').on('submit', function(e){
        ...
        $.ajax({
        url: '<?= base_url()."add_result/reporttest_preview/"; ?>'+jobsid,
        type: 'post',
