...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                <b>Clint Id:</b> #<?= $lab_details[0]["id"] ?><br/>
      ...
      <div class="box box-primary">
		...
		<?php if($labdocks != null){ foreach($labdocks as $docimg){ ?>
          <div class="col-md-4">
    <div class="thumbnail">
	<a href="<?= base_url()."sales/upload/labducuments/".$docimg['dock_name'].'?'.time(); ?>" target="_blank">
     <img src="<?= base_url()."sales/upload/labducuments/".$docimg['dock_name'] ?>" style="width:100%">
	 </a>
    </div>
  </div>
