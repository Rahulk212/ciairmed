...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url(); ?>customer-master/customer-list"><i class="fa fa-users"></i>Spam Job</a></li>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <form role="form" action="<?php echo base_url(); ?>job-master/spam-list" method="get" enctype="multipart/form-data">
                       <div class="col-xs-12">
					<div class="col-xs-4">
					...
					<input type="submit" name="search" class="btn btn-success" value="Search" />
						  ...
						  <a style="float:right;" href='<?php echo base_url(); ?>job_master/export_csv/3' class="btn btn-primary btn-sm" ><i class="fa fa-download" ></i><strong > Export To CSV</strong></a>
...
<a  href='<?php echo base_url(); ?>job_master/job_mark_pending/<?php echo $row['id']; ?>' data-toggle="tooltip" data-original-title="Mark as Spam" ><span class="label label-danger">Mark as Pending</span></a>   
<a  href='<?php echo base_url(); ?>job_master/job_mark_completed/<?php echo $row['id']; ?>' data-toggle="tooltip" data-original-title="Mark as completed" ><span class="label label-success">Mark as completed</span> </a>   
