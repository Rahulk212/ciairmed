            ...
            <div class="col-md-12">
                <div class="panel panel-primary" style="border-color:#bf2d37;">
                    <div class="panel-heading" style="background-color:#bf2d37;">
                        <!-- form start -->
                        <h3 class="panel-title">Edit Leave Type</h3>
                    </div>
                    <form role="form" id="holiday_form" action="<?php echo base_url(); ?>hrm/attendance/leave_type_edit/<?php echo $cid; ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="leave_type" name="leave_type" placeholder="Leave Type" class="form-control" value="<?php echo $query->leave; ?>"/>
                                ...
                                <div class="form-group col-sm-12  pdng_0">
                                    ...
                                    <div class="col-sm-6 pdng_0">
                                        <input type="text" id="number_leaves" name="number_leaves" placeholder="Number of leaves in a year" class="form-control" value="<?php echo $query->number_of_leave; ?>"/>
