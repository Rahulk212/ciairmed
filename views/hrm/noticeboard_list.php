                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
                                        ...
                                        <tr> <td><?php echo $cnt; ?></td>
                                            ...
                                            <td><?php if ($row->active == 1) { ?><span class="label label-success">Active</span><?php } else { ?><span class="label label-danger ">Inactive</span><?php } ?></td>
                                            <td><?php echo date("d-M-Y", strtotime($row->created_date)); ?></td>
                                            <td><a href='<?php echo base_url(); ?>hrm/notice_board/action/<?php echo $row->id; ?>' data-toggle="tooltip" data-original-title="<?php if ($row->active == 1) { ?>Inactive<?php } else { ?>Active<?php } ?>"><?php if ($row->active == 1) { ?><i class="fa fa-ban"></i><?php } else { ?><i class="fa fa-check"></i><?php } ?></a> 
