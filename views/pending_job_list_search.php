                       ...
                       if ($row["is_print"] == 0 && $row["panel_test_count"] == 0) {
                           if ($payable_amount <= 0) {
                            ...
                            <a href='javascript:void(0);' data-toggle="tooltip" data-original-title="Print Report" onclick="$('#print_model').modal('show');
							   ...
							   <a href='javascript:void(0)'  onclick="printreport('<?= $row["id"] ?>');" data-toggle="tooltip" data-original-title="Download Report"><span class=""><i class="fa fa-download fa-6"></i></span></a>
