...
<!--                                        <div class="form-group col-sm-12  pdng_0 mrgn_0">
    ...
    <!--                                        <button class="btn btn-primary pull-right" id="show_test_btn" onclick="show_test_model1();" type="button" style="margin-right:20px"><i class="fa fa-plus-square" style="font-size:20px;"></i> Add Test/Package</button> 
                                            ...
                                            <tbody id="t_body">
                                                ...
                                                foreach ($job_details[0]["test_list"] as $ts1) {
                                                    ...
                                                    <tr id="tr_<?= $cnt ?>">
                                                        ...
                                                        <?php if (!isset($login_data["type"])) { ?>
                                                        <td>Rs.<?= $ts1["info"][0]["price"]; ?></td>
                                                        <?php } ?>
                                                        
                                                        <?php if ($login_data["type"] == 3) { ?>
                                                        <td>Rs.<?= $ts1["info"][0]["price"]; ?></td>
                                                        <td><a href="javascript:void(0);" onclick="delete_city_price('<?= $cnt ?>', '<?= $ts1["info"][0]["price"]; ?>', '<?= $ts1["info"][0]["test_name"]; ?>', '<?= "t-" . $ts1["id"]; ?>')"> Delete</a></td>
                                                        <?php } ?>
                                                    </tr>
                                                    <?php
                                                    $total_price = $total_price + $ts1["info"][0]["price"];
                                                    $cnt++;
                                                }
                                                ?>
                                            </tbody>
                            ...
                            <div class="box box-primary">
                                ...
                                <form role="form" action="<?php echo base_url(); ?>b2b/Lab/upload_report/<?= $id ?>" method="post" enctype="multipart/form-data" id="submit_report">
                                    <div class="box-body">
                                        <div class="form-group">
<!--                                            <input type="file" id="common_report" name="common_report" required="">
                                            <small>(Allow only .pdf file)</small><br>-->
                                           
											
											<?php foreach($jobspdf as $pdf) { ?>
												
												<a href="<?php echo base_url(); ?>upload/business_report/<?php echo $pdf['report']; ?>?<?=date();?>" target="_blank"> <?php echo $pdf['original']; ?> </a><br>
												
												<?php } ?>
                                            <input type="hidden" name="type_common_report" value="c"/>
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control" name="desc_common_report" readonly><?php echo $job_details[0]['report_description']; ?></textarea>
                                        </div>
                                        <div class="box-footer">
<!--                                            <input class="btn btn-primary" value="Upload" type="submit">-->
                        ...
                        <?php if ($login_data["type"] == 3) { ?>
                        <div class="col-md-6">
                            <a href="<?= base_url(); ?>upload/barcode/<?php echo $barcode_detail[0]["pic"]; ?>?<?=date();?>" target="_blank"><img src="<?= base_url(); ?>upload/barcode/<?php echo $barcode_detail[0]["pic"]; ?>" class="col-sm-12"/></a>
                        </div>
                        <?php } ?>
                        ...
                        <script  type="text/javascript">
                                                    function get_test_price() {
                                                        ...
                                                        alert(skillsSelect);console.log(skillsSelect);
