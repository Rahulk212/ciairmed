            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-yellow">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">Rs. <?= $revanu->price; ?></span>
                        <div class="progress">
                            <div style="width: 100%" class="progress-bar"></div>
                        </div>
                      <?php  /* <a href="#" style="color:white;"><span class="progress-description">
                                View More
                            </span></a> */ ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-teal">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?= $totalsample; ?></span>
                        <div class="progress">
                            <div style="width: 100%" class="progress-bar"></div>
                        </div>
                       <?php /* <a href="#" style="color:white;"><span class="progress-description">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-olive">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?= $totaltest->tptaltest; ?></span> 
                        <div class="progress">
                            <div style="width: 100%" class="progress-bar"></div>
                        </div>
                      <?php /*  <a href="#" style="color:white;"><span class="progress-description">
