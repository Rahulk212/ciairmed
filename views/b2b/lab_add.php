                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="lab_name" class="form-control"  value="<?php echo set_value('lab_name'); ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="person_name" class="form-control"  value="<?php echo set_value('person_name'); ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  name="alternate_number" class="form-control"  value="<?php echo set_value('alternate_number'); ?>" >
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="sales_fk">
                                    ...
                                    <option value="<?=$skey["id"];?>"><?=$skey["first_name"]." ".$skey["last_name"];?></option>
                                    <?php } ?>
                                </select>
