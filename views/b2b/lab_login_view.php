    ...
    <body class="bg">
        <div class="login-box">
            ...
            <div class="login-box-body">
                ...
                <form action="<?php echo base_url(); ?>b2b/login1/index" method="post">
                    <div id="login_div">
...
//end new counter
                                ...
                                function check_admin_login() {
                                    ...
                                    $.ajax({
                                        url: "<?php echo base_url(); ?>b2b/Login1/verify_login",
                                        data: {
                                        ...
                                        success: function (data) {
                                            ...
                                            if (json_data.status == '1') {
                                                ...
                                                $("#success_msg").html('<div class="alert alert-success">We will send you OTP on your mobile number.</div>');
                                ...
                                function check_otp() {
                                    ...
                                    if (otp.trim() != '') {
                                        $.ajax({
                                            url: '<?= base_url(); ?>b2b/Login1/check_otp',
                                            type: 'post',
                                            data: {otp: otp},
                                            success: function (data) {
                                                ...
                                                if (jsondata.status == 1) {
                                                    ...
                                                    setTimeout(function () {
                                                        window.location = '<?= base_url() ?>b2b/Lab/dashboard?id=<?php echo time(); ?>';
                                                    }, 1000);
                                                }
                                            },
