    ...
    <nav class="navbar navbar-static-top">
        <div class="">
            <div class="navbar-header">
                <a href="<?php echo base_url(); ?>b2b/Lab/dashboard" class="navbar-brand">Dashboard</a>
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
				...
				<li><a href="<?php echo base_url(); ?>b2b/Lab/sample_add">Sample Registration</a></li>    
                    <li><a href="<?php echo base_url(); ?>b2b/Lab/sample_list">Sample Master</a></li>    
                    <li><a href="<?php echo base_url(); ?>b2b/Lab/payment">Credit Manage</a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
            <!-- Navbar Right Menu -->
...
<!--                                    <a href="<?php echo base_url(); ?>admin-profile-update" class="btn btn-default btn-flat">Profile</a>-->
                                ...
                                <div class="pull-right">
                                    <a href="<?php echo base_url(); ?>b2b/login1/logout1" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
