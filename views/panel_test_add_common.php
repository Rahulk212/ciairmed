        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <p class="help-block" style="color:red;"><?php
                    ...
                    ?></p>
                <!-- form start -->
                <form role="form" action="<?php echo base_url(); ?>Test_panel/panel_test_add/<?= $tid ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                 ...
                                 */ ?>
                                City :
                                <select class="chosen chosen-select" name="city" id="test_city" style="" onchange="get_test(this.value);" >
                                    <option value="">--Select--</option>
                                    <?php foreach ($test_cities as $c) { ?>
                            ...
                            <div class="form-group">Test :
                                <select class="chosen chosen-select" data-live-search="true" name="test" id="testlist" data-placeholder="Select Test">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-primary" type="submit" style="margin-top:10px;float: right;">ADD</button>
                                </div>
                            </div>
                            <!--<div class="form-group">
                                            ...
                                            function get_test($city) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (data) {
                                                        ...
                                                        $("#testlist").html("");
                                                        $("#testlist").html(json_data.test_list);
