        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <?php echo form_open_multipart("add_result/add_value_exists1", array("id" => "add_result", "method" => "post", "onsubmit" => "return check_hundred()")); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        ?>><?php echo $parameter['parameter_name']; ?></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="text" class="number hundread<?php echo $parameter["is_hundred"]; ?>" tabindex="<?php echo $tabindex++; ?>"  formula="<?php echo ( $parameter['formula'] != "") ? "true" : "false"; ?>" name="parameter_value_<?php echo $cnt; ?>" onkeyup="DelayedCallMe(200, '<?= $cnnt ?>', '<?php echo $parameter['id']; ?>');" id="<?= $cnnt ?>_<?php echo $parameter['id']; ?>" value="<?= $parameter['user_val'][0]["value"]; ?>">
                                                            </td>
                                                            <?php if ($testidp["report_type"] == 2) { ?>
...
<script type="text/javascript">
    ...
    function change_order() {
        $("#add_result").attr("action", "<?php echo base_url(); ?>add_result/change_order1");
        setTimeout(function () {
            $("#add_result").submit();
        }, 500);
    }
    ...
    function add_reference(val, val1) {
        jq.fancybox.open({
            href: '<?= base_url(); ?>add_result/add_parameter/' + val + '/' + val1,
            type: 'iframe',
            padding: 5,
            width: '100%',
        });
